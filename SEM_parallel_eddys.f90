...
!THIS IS THE POST-PROCESSING PART, ACTIVATED ONLY IF [POST_PROCESSING] == 1
  IF (POST_PROCESSING == 1 .AND. MYRANK == 0) THEN
    ...
    VEL2_AVERAGE(:) = ((/V_GLOB(IDXY,IDXZ,1)**2,V_GLOB(IDXY,IDXZ,2)**2,V_GLOB(IDXY,IDXZ,3)**2,V_GLOB(IDXY,IDXZ,1)*V_GLOB(IDXY,IDXZ,2), &
			 V_GLOB(IDXY,IDXZ,1)*V_GLOB(IDXY,IDXZ,3), V_GLOB(IDXY,IDXZ,2)*V_GLOB(IDXY,IDXZ,3) /) + VEL2_AVERAGE(:) * (IT-1)) / IT
    TEMP(:) = V(IDXY,IDXZ,:)-U(:)
...
DOUBLE PRECISION :: GENEREPSILO, X, RANDOM
