...
DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE ::          K, PHI, PSI, ALPHA, THETA, KNORM, KNORM_P
...
!------------BEGINNING OF EDDIES ITERATIONS
	...
	ENERGY = AMP * URMS**2.0D0 / KE * ( KNORM(II) / KE)**4.0D0 / &
		 (1.0D0 + (KNORM(II)/KE)**2.0D0)**(17.0D0/6.0D0) * &
		 EXP(-2.0D0 * ( KNORM(II)/KETA )**2.0D0)
